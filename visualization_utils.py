...
class visualize_data(object):
    ...
    def correlation_plot(self):
        """Plots a correlation plot of all the continuous variables in the
        database. This plot helped us remove protein length which was highly
        correlated with protein weight.
        Args, Returns:  None
        """
        # Select only the numeric columns in the DataFrame
        numeric_data = self.data.iloc[:, :8].select_dtypes(include=[np.number])
...
if __name__ == "__main__":
    ...
    db.raw_data = "C:/Users/valib/OneDrive/Desktop/My projects/ENM-Protein-Predictor-master/Input_Files/database.csv"
    db.clean_raw_data()
